...
-->
       ...
       <div id="main">
        ...
        <h1 style="font-weight:normal;">Branch List</h1>
...
$sql = "SELECT br_code, br_name, br_manager, adress,city, contact FROM branches";
...
<td><?php echo $row["br_manager"];?></td>
<td><?php echo$row["adress"];?></td>
<td><?php echo $row["city"];?></td>
<td><?php echo$row["contact"] ;?></td>
<td>
<!--<a href="edit_br.php?br_code=<?php// echo $row['br_code']; ?>">
<button type="update" style="height:40px;background-color:rgba(0,123,255,255);border-color:rgba(0,123,255,255);margin-left:40px">
<i class="fas fa-edit" style="color:white; font-size:19px;"></i>
</button>
</a>
-->

<a href="del_br.php?br_code=<?php echo $row['br_code']; ?>">
<button style="height:40px;background-color:red;border-color:red;width:40px; margin-left:60px">
...
?>
         ...
         <!--  <tr>
             ...
             <td></td>
             <td>
               <button style="height:40px;background-color:rgba(0,123,255,255);border-color:rgba(0,123,255,255);margin-left:40px"><i class="fas fa-edit" style="color:white; font-size:19px"></i></button>
               <button style="height:40px;background-color:red;border-color:red;width:40px;"><i class="fas fa-trash" style="color:white; font-size:19px"></i></button>
             </td>
           </tr>-->
        </table>
        <br>
