...
-->
    ...
    <span  style="display:inline-block;height:25%; width:30%;border:1px solid grey; box-shadow:2px 2px 2px 2px;margin-left:20px; "> 
         
      

    <h1 style="font-weight:normal;margin-left:50px"> Parcels Recieved
        
  </h1>
  <h1 style="margin-left:150px;margin-right:150px">
      <?php
           include 'db_connect.php';
           echo $conn->query("SELECT * FROM parcels WHERE statuss='Parcel Recieved'")->num_rows; 
          ?> 
</h1>
           ...
           <span  style="display:inline-block;height:25%; width:30%;border:1px solid grey; box-shadow:2px 2px 2px 2px; margin-left:20px">
           <h1 style="font-weight:normal;margin-left:100px"> In Transit</h1>
           <h1 style="margin-left:150px;margin-right:150px">
           <?php
           include 'db_connect.php';
           echo $conn->query("SELECT * FROM parcels WHERE statuss='In Transit'")->num_rows; 
          ?> 
          </h1>
          </span>

           <span style="display:inline-block;height:25%; width:30%;border:1px solid grey; box-shadow:2px 2px 2px 2px; margin-left:20px"><h1 style="font-weight:normal;margin-left:120px" >Shipped</h1>
          
          <h1 style="margin-left:150px;margin-right:150px">
          <?php
           include 'db_connect.php';
           echo $conn->query("SELECT * FROM parcels WHERE statuss='Shipped'")->num_rows; 
          ?> 
          </h1>
          </span>
           
           <span style="display:inline-block;height:25%; width:30%;border:1px solid grey; box-shadow:2px 2px 2px 2px;margin-top:25px; margin-left:20px"><h1 style="font-weight:normal;margin-left:50px">Out For Delivery</h1>
          <h1 style="margin-left:150px;margin-right:150px"> <?php
           include 'db_connect.php';
           echo $conn->query("SELECT * FROM parcels WHERE statuss='Out For Delivery'")->num_rows; 
          ?> </h1>
          </span>
           <span style="display:inline-block;height:25%; width:30%;border:1px solid grey; box-shadow:2px 2px 2px 2px;margin-top:25px; margin-left:20px"><h1 style="font-weight:normal;margin-left:100px">Delivered </h1>
           <h1 style="margin-left:150px;margin-right:150px"><?php
           include 'db_connect.php';
           echo $conn->query("SELECT * FROM parcels WHERE statuss='Delivered'")->num_rows; 
          ?> </h1>
           </span>

           <span style="display:inline-block;height:25%; width:30%;border:1px solid grey; box-shadow:2px 2px 2px 2px;margin-top:25px; margin-left:20px"><h1 style="font-weight:normal;margin-left:30px">Delivery Unsuccesful</h1>
           <h1 style="margin-left:150px;margin-right:150px"><?php
           include 'db_connect.php';
           echo $conn->query("SELECT * FROM parcels WHERE statuss='Delivery_Unsuccesfull'")->num_rows; 
          ?> </h1>
          </span>

           <span style="display:inline-block;height:25%; width:30%;border:1px solid grey; box-shadow:2px 2px 2px 2px;margin-top:25px; margin-left:20px"><h1 style="font-weight:normal;margin-left:50px">Package Returned</h1>
           <h1 style="margin-left:150px;margin-right:150px">
           <?php
           include 'db_connect.php';
           echo $conn->query("SELECT * FROM parcels WHERE statuss='Package_Returned'")->num_rows; 
          ?> </h1>
          </span>
