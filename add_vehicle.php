...
-->
        ...
        <h1 style="font-weight:normal;">New Vehicle</h1>
           ...
           <form action="vcl_database.php" method="post" style="background-color:white; margin: 25px 25px; border:1px solid grey; box-shadow:10px 10px 10px 10px grey;" >
                 <br>
                <label for="labels" style="margin:10px 10px 10px 10px;"> <b> Type</b></label>
                <label style="margin:10px 10px 20px 490px;"> <b>Registration#/Number Plate</b> </label>
                <br>
                <select name="type" style="margin:10px 18px 10px 10px; height:40px; width:47%" >
                   <option value="Truck">Truck</option>
                   <option value="Bike"> Bike</option>
                   <option value="Train">Train</option>
                </select>
                <input type="text" name="reg#" value="<?php echo rand(); ?>" readonly style="margin:10px 10px 10px 18px; height: 40px; width:47%" class="inputs">
                <br>
 
                <label for="labels"  style="margin:10px 10px 10px 10px;"> <b> Assigned to</b></label>
                <label style="margin:10px 10px 20px 443px;"> <b>City </b> </label>
                <br>
                <select name="assign_to" style="margin:10px 18px 10px 10px; height:40px; width:47%" >
                  <?php
...
$conn->close();
                ...
                <input type="text" name="city" style="margin:10px 10px 10px 18px; height: 40px; width:47%" class="inputs">
