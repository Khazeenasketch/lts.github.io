        ...
        <div id="main">
         <div> <a href="logout.php">
          <button class="fas fa-sign-out-alt elements" id="lo"  >
           ...
           <h1 style="font-weight:normal;">New Branch</h1>
           ...
           <form action="br_database.php"  method="post" style="background-color:white; margin: 25px 25px; border:1px solid grey; box-shadow:10px 10px 10px 10px grey;" >
                 <br>
                ...
                <br>
                <input type="text" name="address" style="margin:10px 18px 10px 10px; height:40px; width:47%" class="inputs">
                <input type="text" name="city" style="margin:10px 10px 10px 10px; height: 40px; width:47%" class="inputs">
                <br>
                ...
                <br>
                <input type="text"name="br_manager" style="margin:10px 18px 10px 10px; height:40px; width:47%" class="inputs">
                <input type="text" name="br_name" style="margin:10px 10px 10px 10px; height: 40px; width:47%" class="inputs">
                <br>
                ...
                <input type="number"name="contact" style="margin:10px 10px 10px 10px; height: 40px; width:47%" class="inputs">
                ...
                <br>
                <button type="submit" name="submit" style="background-color:rgba(0,123,255,255); height:40px; width:120px; border=0px;margin-left: 395px; margin-bottom:10px;">Save</button>
