...
-->
        ...
        <h1 style="font-weight:normal;">Courier List</h1>
...
$sql = "SELECT names,dp_id, CNIC, salary, adress, phone_no,dob, gender, email, br_codes FROM courier";
...
<a href="del_dp.php?dp_id=<?php echo $row['dp_id']; ?>">
<button style="height:40px;background-color:red;border-color:red;width:35px;margin-left:35px">
...
?>
          <!-- <tr>
             ...
             <td></td>
             <td>
               <button style="height:40px;background-color:rgba(0,123,255,255);border-color:rgba(0,123,255,255);margin-left:70px"><i class="fas fa-edit" style="color:white; font-size:19px"></i></button>
