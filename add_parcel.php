...
-->
       ...
       <div id="main">
        ...
        <h1 style="font-weight:normal;">New Parcel</h1>
           <hr style="border-color:rgba(0,123,255,255);">
          
          
           

           <form action="par_database.php" method="post"  style="background-color:white; margin: 25px 25px; border:1px solid grey; box-shadow:10px 10px 10px 10px grey;" >
              
                <br>
                <label for="labels" style="margin:10px 10px 10px 10px;"> <b> Sender Information</b></label>
                <label style="margin:10px 10px 20px 385px;"> <b>Recipient Information</b> </label>
                <br>
                <br>
                <label for="labels" style="margin:10px 10px 10px 10px;"> <b> Name</b></label>
                <label style="margin:10px 10px 20px 480px;"> <b>Name</b> </label>
                <br>
                <select name="sen_name" style="margin:10px 18px 10px 10px; height:40px; width:47%" >
                  <?php
...
$sql_s = "SELECT names FROM customers";
...
$conn->close();
                ...
                <input type="text"name="rec_name" style="margin:10px 10px 10px 18px; height: 40px; width:47%" class="inputs">
                <br>
 
                <label for="labels"  style="margin:10px 10px 10px 10px;"> <b> Address</b></label>
                <label style="margin:10px 10px 20px 465px;"> <b>Address</b> </label>
                <br> 
                <input type="text" name="sen_address" style="margin:10px 18px 10px 10px; height:40px; width:47%" class="inputs">
                <input type="text" name="rec_address" style="margin:10px 10px 10px 18px; height: 40px; width:47%" class="inputs">
                <br>

                <label for="labels"  style="margin:10px 10px 10px 10px;"> <b> Contact#</b></label>
                <label style="margin:10px 10px 20px 460px;"> <b>Contact#</b> </label>
                <br>
                <input type="number" name="sen_phone"style="margin:10px 18px 10px 10px; height:40px; width:47%" class="inputs">
                <input type="number" name="rec_phone" style="margin:10px 10px 10px 18px; height: 40px; width:47%" class="inputs">
                
                <br>
                <hr style="border 1px solid grey">
                
                <label for="labels" style="margin-left:10px"> <b>Branch Processed</b> </label>
                <label for="labels" style="margin-left:413px"> <b>Assign To</b> </label>

                <br >
                <select name="br_code" style="margin:10px 18px 10px 10px; height:40px; width:47%" >
                  <?php
                        $conn = mysqli_connect("localhost", "root", "", "lts_db");
// Check connection
if ($conn->connect_error) {
...
<select name="dp_name" style="margin:10px 18px 10px 10px; height:40px; width:47%" >
                  <?php
                        $conn = mysqli_connect("localhost", "root", "", "lts_db");
// Check connection
if ($conn->connect_error) {
...
$sql_s = "SELECT names FROM courier";
...
$conn->close();
                ...
                <hr>
                <label for="labels" style="margin-left:10px"> <b>Parcel Information</b> </label>
                <table style="margin-left:15px;margin-top:10px; border:1px solid black; border-collapse:collapse">
                <tr>
                  
                  <th style="border:1px solid black; border-collapse:collapse;height:45px; width:200px" >Weight</th>
                  <th style="border:1px solid black; border-collapse:collapse;height:45px; width:200px">Height</th>
                  <th style="border:1px solid black; border-collapse:collapse;height:45px; width:200px">Length</th>
                  <th style="border:1px solid black; border-collapse:collapse;height:45px; width:200px">Width</th>
                  <th style="border:1px solid black; border-collapse:collapse;height:45px; width:200px">Price</th>
                </tr>
                <tr>
                    <td style="border:1px solid black; border-collapse:collapse;height:45px; width:200px">
                     <input type="number" id=" w" name="weight" style="margin-left:11px;">
                  </td>
                    <td style="border:1px solid black; border-collapse:collapse;height:45px; width:200px">
                    <input type="number"  id="h"name="height" style="margin-left:11px;">
                  </td>
                    <td style="border:1px solid black; border-collapse:collapse;height:45px; width:200px">
                    <input type="number" name="length"style="margin-left:11px;">
                  </td>
                    <td style="border:1px solid black; border-collapse:collapse;height:45px; width:200px">
                    <input type="number"name="width" style="margin-left:11px;">
                  </td>
                    <td style="border:1px solid black; border-collapse:collapse;height:45px; width:200px">
                    <input type="number" name="price" style="margin-left:11px;">
                  </td>
...
<br><br>
                ...
                <a href="">
                <button style="background-color:grey; height:40px; width:120px; border=0px; margin-left:10px">Cancel</button></a>
                <br>
