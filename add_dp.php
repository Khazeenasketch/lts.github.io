...
-->
       ...
       <div id="main">
        ...
        <h1 style="font-weight:normal;">New Staff</h1>
           ...
           <form action="dp_database.php" method="post"  style="background-color:white; margin: 25px 25px; border:1px solid grey; box-shadow:10px 10px 10px 10px grey;" >
              
           <br>
                
                <label for="labels" style="margin:10px 10px 10px 10px;"> <b> Full Name</b></label>
                <label   style="margin:10px 10px 20px 450px;" > <b>Branch</b> </label>
                <br>
                <input  type="text" name="st_name" style="margin:10px 18px 10px 10px; height:40px;width:47%" class="inputs">
                <select name="br_code" style="margin:10px 10px 10px 18px; height:40px; width:47%" >
                  <?php
...
$conn->close();
                ...
                <label for="labels" style="margin:10px 10px 10px 483px;"> <b> Password</b></label>
                <br>
                <input type="text"  name="st_email"  style="margin:10px 18px 10px 10px; height:40px; width:47%" class="inputs">
                <input type="password"  name="st_password" style="margin:10px 10px 10px 18px; height:40px; width:47%" class="inputs">
                <br>
                ...
                <input type="number"name="st_cnic"  style="margin:10px 10px 10px 18px; height:40px; width:47%" class="inputs">
                <br>
                <label for="labels"   style="margin:10px 10px 10px 10px;"> <b> Address</b></label>
                <label for="labels"   style="margin:10px 10px 10px 463px;"> <b> Gender</b></label>
                <br>
                <input type="text"  name="st_address"style="margin:10px 18px 10px 10px;height:40px; width:47%" class="inputs">
                <SELEct name="st_gender" style="margin:10px 10px 10px 18px; height:40px; width:47%">
 ...
 <label for="labels" style="margin:10px 10px 10px 473px;"> <b> Date of birth</b></label>
 <br>
 <input type="number"  name="st_salary"  style="margin:10px 18px 10px 10px; height:40px; width:47%" class="inputs">
 <input type="date"  name="st_dob" style="margin:10px 10px 10px 18px; height:40px; width:47%" class="inputs">
