...
-->
        ...
        <h1 style="font-weight:normal;">Staff List</h1>
...
$sql = "SELECT names, CNIC, salary, adress, phone_no, emp_id, dob, gender, email, br_code FROM employe";
...
<a href="del_st.php?emp_id=<?php echo $row['emp_id']; ?>">
<button style="height:40px;background-color:red;border-color:red;width:40px;margin-left:35px">
