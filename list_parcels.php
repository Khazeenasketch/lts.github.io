...
-->
       ...
       <div id="main">
        ...
        <h1 style="font-weight:normal;">Parcel List</h1>
           <hr style="border-color:rgba(0,123,255,255);">
          <br>
         
          <div style="background-color:white; margin: 25px 25px; border:1px solid grey; box-shadow:10px 10px 10px 10px grey;" >
          <a href="add_parcel.php">
          <button style="margin-left:960px; margin-top:10px; margin-bottom:3px; border-color:rgba(0,123,255,255); height:30px"> <b style="font-size:15px"> + </b>Add New</button></a>
         <hr style="border-color:rgb(211,211,211)"><br>
        
          <!-- <input type="text" placeholder="Search" style="margin-left:860px; margin-bottom:10px; margin-top:5px;height:35px">-->

           <table style="border-collapse: collapse;margin-left:10px;margin-right:10px  ">
...
<td>
<!--<a href="">
<button style="height:40px;background-color:green;border-color:green;width:30px">
<i class="fas fa-eye" style="color:white; font-size:15px;"></i>
</button>
</a>
<a href="">
<button style="height:40px;background-color:rgba(0,123,255,255);border-color:rgba(0,123,255,255);width:30px;margin-left:-4px">
<i class="fas fa-edit" style="color:white; font-size:15px"></i>
</button>  
</a>-->

<a href="del_par.php?parcel_id=<?php echo $row['parcel_id']; ?>">
<button style="height:40px;background-color:red;border-color:red;width:40px;margin-left:40px">
<i class="fas fa-trash" style="color:white; font-size:19px"></i>
</button>  
</a>
...
?>
           ...
           <!--<tr>  <td></td>
             ...
             <td></td>
             <td >
             <button  style="height:40px;background-color:green;border-color:green;width:30px;margin-left:5px"><i class="fas fa-eye" style="color:white; font-size:15px"></i></button>
             <button style="height:40px;background-color:rgba(0,123,255,255);border-color:rgba(0,123,255,255);width:30px"><i class="fas fa-edit" style="color:white; font-size:15px"></i></button>
               <button style="height:40px;background-color:red;border-color:red;width:30px;"><i class="fas fa-trash" style="color:white; font-size:15px"></i></button>
             </td>
           </tr>-->
        </table>
        <br>
