...
-->
       ...
       <div id="main">
        ...
        <h1 style="font-weight:normal;">Customer List</h1>
...
$sql = "SELECT names,phone_no, adress, cust_id, email_cus, phone_no, code,CNIC_cus FROM customers";
...
<a href="del_cus.php?cust_id=<?php echo $row['cust_id']; ?>">
...
?>
         ...
         <!--  <tr>
             ...
             <td></td>
             <td>
               <button style="height:40px;background-color:rgba(0,123,255,255);border-color:rgba(0,123,255,255);margin-left:30px"><i class="fas fa-edit" style="color:white; font-size:19px"></i></button>
