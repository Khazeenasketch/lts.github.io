...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styling.css" media="all"></link>
    ...
    function openNav() {
     ...
     function dropupb(){
      ...
      function dropdownbs(){
        ...
        document.getElementsByClassName('display')[2].style.display='block'; 
        document.getElementsByClassName('display')[3].style.display='block'; 
        
    }

     function dropupbs(){
      document.getElementsByClassName('display')[2].style.display='none'; 
        document.getElementsByClassName('display')[3].style.display='none';
        ...
        <div class="style" id="menu" >
            ...
            <div class="elements" > 
              ...
              <div class=" text" > 
                ...
                <span class="fa fa-angle-down ml-2 ar-h-w " onclick="Branchstaff(this)" style="left: 17px;" >
