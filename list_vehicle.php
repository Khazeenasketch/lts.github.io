...
-->
       ...
       <div id="main">
        ...
        <h1 style="font-weight:normal;">Vehicle List</h1>
...
$sql = "SELECT typ,reg_no,city,dps_id,branch FROM vehicles"; 
...
<a href="del_vcl.php?reg_no=<?php echo $row['reg_no']; ?>">
<button style="height:40px;background-color:red;border-color:red;width:40px;margin-left:75px">
...
?>
         ...
         <!--  <tr>
             ...
             <td></td>
             <td>
               <button style="height:40px;background-color:rgba(0,123,255,255);border-color:rgba(0,123,255,255);margin-left:50px"><i class="fas fa-edit" style="color:white; font-size:19px"></i></button>
