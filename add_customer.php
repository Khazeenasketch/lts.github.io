...
-->
       ...
       <div id="main">
        ...
        <h1 style="font-weight:normal;">New Customer</h1>
           ...
           <form action="cus_database.php" method="post"  style="background-color:white; margin: 25px 25px; border:1px solid grey; box-shadow:10px 10px 10px 10px grey;" >
                 <br>
                <label for="labels" style="margin:10px 10px 10px 10px;"> <b> Name</b></label>
                <label style="margin:10px 10px 20px 480px;"> <b>Phone#</b> </label>
                <br>
                <input type="text" name="cus_name" style="margin:10px 18px 10px 10px; height:40px; width:47%" class="inputs">
                <input type="number"name="cus_phone" style="margin:10px 10px 10px 18px; height: 40px; width:47%" class="inputs">
                <br>
 
                <label for="labels"  style="margin:10px 10px 10px 10px;"> <b> Address</b></label>
                <label style="margin:10px 10px 20px 465px;"> <b>Customer_id</b> </label>
                <br>
                <input type="text" name="cus_address"style="margin:10px 18px 10px 10px; height:40px; width:47%" class="inputs">
                <input type="number" name="cus_id" style="margin:10px 10px 10px 18px; height: 40px; width:47%" class="inputs" value="<?php echo rand();?>" readonly>
                <br>

                <label for="labels"  style="margin:10px 10px 10px 10px;"> <b> Email</b></label>
                <label style="margin:10px 10px 20px 480px;"> <b>City</b> </label>
                <br>
                <input type="text" name="cus_email" style="margin:10px 18px 10px 10px; height:40px; width:47%" class="inputs">
                <input type="text"name="cus_city" style="margin:10px 10px 10px 18px; height: 40px; width:47%" class="inputs">
                <br>
                <label for="labels"  style="margin:10px 10px 10px 10px;"> <b> Branch</b></label>
                <label for="labels"  style="margin:10px 10px 10px 473px;"> <b> CNIC</b></label>
...
$conn->close();
                ...
                <input type="number"name="cnic" style="margin:10px 10px 10px 18px; height: 40px; width:47%" class="inputs">
                <br>
